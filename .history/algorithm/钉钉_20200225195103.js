...
// console.log(compareVersion('2.2.0.0.1', '2.2.0'));
...
function parseCood(str) {
  ...
  let col = alphaArr.length > 1 ? 26 * (alphaArr.length - 1) + transfer(alphaArr[alphaArr.length - 1]) : transfer(alphaArr[0])
  return ({
    col: Number(col),
    row: Number(numStr)
  })
...
console.log(parseCood('A1'));
console.log(parseCood('AB123'));